    ...
    <div>
     ...
     <nav class="space-y-1 text-xs font-normal text-black">
		...
		<a class="block px-3 py-1.5 
		                ${pageContext.request.requestURI.contains('/employee') ? 'bg-[#f9e9e9]' : ''}" 
		...
		<a class="block px-3 py-1.5 
		   ...
		   href="<c:url value='/admin/leaves' />">
		    Leaves
		</a>
		<a class="block px-3 py-1.5 
		                ${pageContext.request.requestURI.contains('/attendance') ? 'bg-[#f9e9e9]' : ''}" 
		   href="<c:url value='/admin/attendance' />">
		    Attendance
		</a>
		<a class="block px-3 py-1.5 
		                ${pageContext.request.requestURI.contains('/payroll') ? 'bg-[#f9e9e9]' : ''}" 
		   href="<c:url value='/admin/payroll' />">
		    Payroll
		</a>
		<a class="block px-3 py-1.5 
		                ${pageContext.request.requestURI.contains('/logs') ? 'bg-[#f9e9e9]' : ''}" 
		   href="<c:url value='/admin/logs' />">
		    Logs
		</a>
